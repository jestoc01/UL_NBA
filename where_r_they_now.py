...
player_choice = ''
while True:
# Here is an updatable dictionary of former University of Louisville players CURRENTLY in the NBA matched with their team.
	current_ul_nba_dict = {'Gorgui Dieng':'Grizzlies', 'Montrezl Harrell':'Lakers', 'Damion Lee':'Warriors', 'Donovan Mitchell':'Jazz', 'Jordan Nwora':'Bucks', 'Terry Rozier':'Hornets'}
